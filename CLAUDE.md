...
This project is indexed by GitNexus as **pare** (466 symbols, 452 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
