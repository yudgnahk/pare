...
final class AppManagerViewModelTests: XCTestCase {
    ...
    func testLoadStateEquality() {
        XCTAssertEqual(AppManagerViewModel.LoadState.idle, .idle)
        XCTAssertEqual(AppManagerViewModel.LoadState.loading, .loading)
        XCTAssertEqual(AppManagerViewModel.LoadState.loaded, .loaded)
        XCTAssertEqual(AppManagerViewModel.LoadState.error("x"), .error("x"))
        XCTAssertNotEqual(AppManagerViewModel.LoadState.error("x"), .error("y"))
        XCTAssertNotEqual(AppManagerViewModel.LoadState.idle, .loading)
        XCTAssertNotEqual(AppManagerViewModel.LoadState.loaded, .error("x"))
    }
