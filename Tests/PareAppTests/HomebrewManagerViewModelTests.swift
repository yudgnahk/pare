...
final class HomebrewManagerViewModelTests: XCTestCase {
    ...
    func testLoadStateEquality() {
        XCTAssertEqual(HomebrewManagerViewModel.LoadState.idle, .idle)
        XCTAssertEqual(HomebrewManagerViewModel.LoadState.error("a"), .error("a"))
        XCTAssertNotEqual(HomebrewManagerViewModel.LoadState.error("a"), .error("b"))
        XCTAssertNotEqual(HomebrewManagerViewModel.LoadState.loading, .loaded)
    }
