...
- New file: `Sources/CleanMyMacCore/Rules/DockerLogsReviewRequiredRule.swift`
...
- New file: `Sources/CleanMyMacCore/Rules/DockerVMDataAdvancedRule.swift`
- Category: `.developerPackageCaches`
- Risk: `.advanced`
- Include logic:
...
- Update `Sources/CleanMyMacCore/Scanning/RuleCatalog.swift`:
  - append Docker review + advanced rules to developer rule list.

5) Add and update tests
- Update `Tests/CleanMyMacCoreTests/ScanRunnerTests.swift` for:
