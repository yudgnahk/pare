...
**Date:** 2026-07-20  
**Inputs:** Current Pare master (Phases 1–8 + Leave Homebrew #24), refreshed [App A comparison](../features/comparison-app-a.md), new [App B comparison](../features/comparison-app-b.md), open [US-4](../user-stories.md).
...
| [comparison-app-b.md](../features/comparison-app-b.md) | New App B module map + do-not-build list |
