...
**App A** (github.com/example/app-a-cli — the reference Go+Bash "clean macOS" CLI) has 8 commands and covers a wide surface area. This document maps the gaps and advantages.
