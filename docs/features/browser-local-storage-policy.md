...
Local Storage is **not** macOS Keychain, but it is **credential-adjacent**. CleanMyMac / Mole win large Chrome reclaim primarily via **HTTP cache** and **Service Worker** caches—not by default-wiping Local Storage.
