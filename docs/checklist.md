...
- [ ] Create a macOS SwiftUI app target (for example, `CleanMyMacApp`) in the same package/workspace.
- [ ] Reuse `CleanMyMacCore` directly from the app target (no duplicated scan logic).
