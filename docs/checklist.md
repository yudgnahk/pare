...
- [x] Add incremental scan metadata cache. → **US-2**
...
- [x] Benchmark large directories and optimize hotspots. → **US-2**
- [x] Add reliability tests for interrupted scans. → **US-2**
...
- [x] **US-7** Homebrew Bulk Actions, Explicit Confirmation, and Last Used
